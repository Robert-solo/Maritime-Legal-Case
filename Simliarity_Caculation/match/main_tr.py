...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 24 14:19:35 2019
...
#all_que_slices = preprocess.ex_que(all_que_slices)
...
sni2_score_list = ma.getsimbm25(all_doc_slices,all_que_slices,rel_docs,docs_have,file_index,2)


#sni1_score_list = ma.getsimbm25forfullsearch(all_doc_slices,all_que_slices,file_index,2)
#sni2_score_list = ma.getsimbm25forfullsearch(all_doc_slices,all_que_slices,file_index,3)
